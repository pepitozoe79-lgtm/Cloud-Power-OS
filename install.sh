#!/bin/bash
# ==============================================
# Cloud Power OS - Universal Installer v2.0.2
...
cleanup_error() {
    echo -e "\n${RED}🛑 La instalación ha fallado en la línea $1.${NC}"
    echo -e "${YELLOW}🔍 Sugerencia: Revisa tu conexión a internet o ejecuta 'journalctl -xe' para más detalles.${NC}"
    echo -e "${YELLOW}📋 Puedes reportar este error en: https://github.com/pepitozoe79-lgtm/Cloud-Power-OS/issues${NC}"
    exit 1
}
trap 'cleanup_error $LINENO' ERR

echo -e "${BLUE}⚡ Iniciando instalación de Cloud Power OS v2.0.2...${NC}"
